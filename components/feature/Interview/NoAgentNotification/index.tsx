...
import { timeWaitForAgent } from "@/utils/constant";
 ...
 */
const NoAgentNotification = (props: NoAgentNotificationProps) => {
  const timeToWaitMs = timeWaitForAgent;
...
export default NoAgentNotification